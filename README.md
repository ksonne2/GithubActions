[![Run App Sonne, Kyle](https://github.com/ksonne2/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ksonne2/GithubActions/actions/workflows/run-app.yaml)
